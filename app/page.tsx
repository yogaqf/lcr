...
const span = `${bebasNeue.className} font-bold text-[8vw] sm:text-[2.5vw] text-white leading-none`
  ...
  return (
    <div className={container}>
      ...
      <div className={wrapper}>
        <div className={card}>
          <div className={img} style={{ backgroundImage: `url(${resortManager[0].image})` }}></div>
